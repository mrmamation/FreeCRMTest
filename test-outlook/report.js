$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("C:/bin/Eclipse-Tests/FreeCrmBDDFramework/src/main/java/Features/tagging.feature");
formatter.feature({
  "line": 2,
...
formatter.step({
  "line": 22,
  "name": "This is a contact task case",
  "keyword": "Given "
});
formatter.match({});
formatter.result({
...
formatter.scenario({
  ...
  "name": "Search docs",
  "description": "",
  "id": "free-crm-application-testing;search-docs",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.scenario({
  ...
  "name": "Search forms",
  "description": "",
  "id": "free-crm-application-testing;search-forms",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
